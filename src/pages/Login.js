...
const Login = () =>{
    ...
    const handleFocus = () => {
        if (IsFocus){
            document.querySelector(".text").innerHTML="휴대폰 번호, 이메일 주소 또는 사용자 아이디";
        }
    }
     ...
     <>
        ...
        <StyledDiv>
            ...
            (<div>
                ...
                <IdInput onBlur={()=>{setIsFocus(false)}} ref={Ref}></IdInput>
            </div>)
            :(<IdInput ref={InputRef} onFocus={()=>{
                setIsFocus(true)
                Ref.current.focus()
            }} 
            placeholder="휴대폰 번호, 이메일 주소 또는 사용자 아이디" type="text"></IdInput>)} */}
        ...
        <StyledButton bgcolor="black" color="white">다음</StyledButton>
